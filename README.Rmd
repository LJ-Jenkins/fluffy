...
fluffy provides three [S7](https://cran.r-project.org/web/packages/S7/index.html) classes: `Registry`, `Schema`, and `Validator`.
...
fluffy was inspired by and modelled on Python's [Cerberus](https://docs.python-cerberus.org/) (hence the name!). Error printing in fluffy was modelled on [lobstr](https://lobstr.r-lib.org/)'s tree function. fluffy was originally called 'RV' but was renamed to distinguish itself from the [rv package manager for R](https://github.com/A2-ai/rv).
